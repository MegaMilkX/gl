...
void WGLEXTLoadFunctions()
{
    ...
    GLPROCLOAD(PFNWGLCHOOSEPIXELFORMATARBPROC, wglChoosePixelFormatARB);
...
void GLEXTLoadFunctions()
{
    ...
    GLPROCLOAD(PFNGLDRAWARRAYSINSTANCEDPROC, glDrawArraysInstanced);
    GLPROCLOAD(PFNGLDRAWELEMENTSINSTANCEDPROC, glDrawElementsInstanced);
    ...
    GLPROCLOAD(PFNGLDISABLEVERTEXATTRIBARRAYPROC, glDisableVertexAttribArray);
    GLPROCLOAD(PFNGLDELETEVERTEXARRAYSPROC, glDeleteVertexArrays);

    GLPROCLOAD(PFNGLVERTEXATTRIBDIVISORPROC, glVertexAttribDivisor);
    ...
    GLPROCLOAD(PFNGLGETACTIVEUNIFORMBLOCKIVPROC, glGetActiveUniformBlockiv);
    ...
    GLPROCLOAD(PFNGLCREATESHADERPROGRAMVPROC, glCreateShaderProgramv);
    GLPROCLOAD(PFNGLCREATESHADERPROGRAMEXTPROC, glCreateShaderProgramExt);
    GLPROCLOAD(PFNGLGENPROGRAMPIPELINESPROC, glGenProgramPipelines);
    GLPROCLOAD(PFNGLDELETEPROGRAMPIPELINESPROC, glDeleteProgramPipelines);
    GLPROCLOAD(PFNGLBINDPROGRAMPIPELINEPROC, glBindProgramPipeline);
    GLPROCLOAD(PFNGLUSEPROGRAMSTAGESPROC, glUseProgramStages);
    ...
    GLPROCLOAD(PFNGLGETACTIVEUNIFORMARBPROC, glGetActiveUniformARB);
    GLPROCLOAD(PFNGLGETACTIVEUNIFORMBLOCKNAMEPROC, glGetActiveUniformBlockName);

    GLPROCLOAD(PFNGLGETPROGRAMINTERFACEIVPROC, glGetProgramInterfaceiv);
    GLPROCLOAD(PFNGLGETPROGRAMRESOURCENAMEPROC, glGetProgramResourceName);
    ...
    GLPROCLOAD(PFNGLTEXBUFFERPROC,              glTexBuffer);
    ...
    GLPROCLOAD(PFNGLGETFRAGDATALOCATIONPROC, glGetFragDataLocation);
    ...
    GLPROCLOAD(PFNGLGETUNIFORMINDICESPROC, glGetUniformIndices);
    GLPROCLOAD(PFNGLGETACTIVEUNIFORMSIVPROC, glGetActiveUniformsiv);
    ...
    GLPROCLOAD(PFNGLDEBUGMESSAGECALLBACKPROC, glDebugMessageCallback);
